...
<div class="fixed top-1 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-sm px-3 py-1 rounded shadow z-10">
  {currentDate}
</div>

<div class="h-full bg-gray-100 flex overflow-x-auto" bind:this={timelineContainer}>
  <div class="w-max flex-col flex p-2 pt-9 space-y-2">
    <div

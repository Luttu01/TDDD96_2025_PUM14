...
def navigate_to_documents(page: Page, setup_mocks):
    ...
    # No need to select a patient as the application doesn't have that functionality yet
    # Just verify that the welcome message is displayed
    page.wait_for_selector(".welcome-message", timeout=5000)

# Section 1: Rendering och Layout
def test_1_1_panel_exists(page: Page, navigate_to_documents):
...
def test_1_4_unit_list(page: Page, navigate_to_documents):
...
def test_1_6_professional_role_list(page: Page, navigate_to_documents):
    ...
    role_dropdown = page.locator("#Yrkesroll")
...
def test_1_7_reset_button(page: Page, navigate_to_documents):
...
def test_2_1_date_filtering(page: Page, navigate_to_documents):
...
def test_2_2_journal_type_filter(page: Page, navigate_to_documents):
...
def test_2_3_unit_filter(page: Page, navigate_to_documents):
...
def test_2_4_search_term_filter(page: Page, navigate_to_documents):
...
def test_2_5_professional_role_filter(page: Page, navigate_to_documents):
...
def test_2_6_combined_filters(page: Page, navigate_to_documents):
...
def test_2_7_reset_filters(page: Page, navigate_to_documents):
...
def test_3_1_invalid_date(page: Page, navigate_to_documents):
    """Test invalid date handling"""
    # Try to set an invalid date
    date_input = page.locator("#DatumÄldst")
...
def test_3_2_empty_search(page: Page, navigate_to_documents):
...
def test_3_3_date_order(page: Page, navigate_to_documents):
...
def test_3_4_special_characters(page: Page, navigate_to_documents):
...
def test_4_1_date_change(page: Page, navigate_to_documents):
...
def test_4_2_type_change(page: Page, navigate_to_documents):
...
def test_4_3_unit_change(page: Page, navigate_to_documents):
...
def test_4_4_search_term_change(page: Page, navigate_to_documents):
...
def test_4_5_role_change(page: Page, navigate_to_documents):
